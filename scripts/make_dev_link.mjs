...
// sukaPC
const targetDir = 'C:\\D\\Document\\siyuan-test\\data\\widgets'
//Like this
...
if (!fs.existsSync('./widget.json')) {
    console.error('Failed! widget.jsonn not found');
    process.exit(1);
}
...
if (!name || name === '') {
    console.log('Failed! Please set widget name in widget.json');
    process.exit(1);
}
