...
### 提醒：该挂件需要 KMind 插件的 api 支持，才能使用悬浮预览思源块的功能，自定义主题，全局超链接等功能
...
KMind2 不会立刻停止使用，但 KMind Zen 会是之后主要投入和更新的方向。强烈建议你开始尝试，并逐步迁移到 KMind Zen。思源集市中可以直接搜索下载 KMind Zen。
